      ...
      */}
      <div className="container mx-auto px-6 md:px-12 lg:px-20 py-12 md:py-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex justify-center lg:justify-end items-center z-10 w-full mt-10 lg:mt-0">
          {/* NEW INNER WRAPPER: Required for absolute positioning of shadow */}
          <div className="relative inline-flex flex-col items-center">
            ...
            {/* SHADOW ELEMENT: Adds the ground shadow effect */}
            {/*
              - absolute -bottom-2: Positions it just below the image boundary
              - w-[40%]: Shadow is narrower than the body
              - h-6: Sets height for the oval
              - bg-neutral-900/50: Dark background with semi-transparency
              - rounded-full: Creates the ellipse shape
              - blur-xl: Heavily softens the edges
            */}
            <div className="absolute -bottom-1 w-[40%] h-6 bg-neutral-900/60 rounded-full blur-xl scale-y-75 transform-origin-center"></div>
          </div>
        </div>
      </div>
    </section>
